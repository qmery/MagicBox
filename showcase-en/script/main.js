...
var qmery = function(groupHash,callback){
	...
	holderTemplate = '<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 playlist no_padding"> \
							<h3>\
								<a href="category.html" class="qmsc-title qmsc-link">(<span class="Number-cat eng">2</span>)\
									\
									دسته بندی\
								</a>\
							</h3>\
	...
	renderCategories = function(holder) {
		$.each(this.categories,function(k,v){
			...
			template.find('.qmsc-title').html(v.title + ' <i class="fa fa-chevron-right" aria-hidden="true"></i> (' + v.video_count +')');
